...
//        public int kolichestvoIgrokov { get; set; }
...
//                {
//                    if (deka.Count == 0) break;

//                    player.kartas.Add(deka[0]);
//                    deka.RemoveAt(0);
//                }
//            }
//        }
...
//            {
//                Random random = new Random();
//                int randomIndex = random.Next(player.kartas.Count);
//                Karta playedCard = player.kartas[randomIndex];

//                Console.WriteLine($"Игрок {players.IndexOf(player) + 1} кладет карту: {playedCard.Value} {playedCard.Mast}");
